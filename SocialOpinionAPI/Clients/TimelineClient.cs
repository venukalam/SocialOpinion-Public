...
namespace SocialOpinionAPI.Clients
{
    public class TimelineClient
    {
        ...
        private string _reverseChronologicalTimeline = "https://api.twitter.com/2/users/:id/timelines/reverse_chronological";
        ...
        public string GetReverseChronologicalTimeline(string id, DateTime? endtime,
                               string expansions, int maxResults, string mediafields,
                               string pagination_token, string placefields, string pollfields,
                               string since_id, DateTime? start_time, string tweet_fields,
                               string until_id, string user_fields)
        {
            _reverseChronologicalTimeline = _reverseChronologicalTimeline.Replace(":id", id);
            RequestBuilder rb = new RequestBuilder(_oAuthInfo, "GET", _reverseChronologicalTimeline);
